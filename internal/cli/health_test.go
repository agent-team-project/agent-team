...
func TestHealthCommandFormatExitsUnhealthy(t *testing.T) {
	...
	if got, want := stdout.String(), "false:false:0:7\n"; got != want {
...
func TestHealthQuietRejectsOutputConflicts(t *testing.T) {
	cases := []struct {
		...
		{[]string{"health", "--commands", "--json"}, wantCommandsModeConflict("--json")},
		{[]string{"health", "--commands", "--format", "{{.Healthy}}"}, wantCommandsModeConflict("--format")},
		{[]string{"health", "--commands", "--quiet"}, wantCommandsModeConflict("--quiet")},
		{[]string{"health", "--commands", "--watch"}, wantCommandsModeConflict("--watch")},
		{[]string{"health", "--commands", "--wait"}, wantCommandsModeConflict("--wait")},
...
func TestHealthWaitFormatTimesOutWithFinalSnapshot(t *testing.T) {
	...
	if got, want := stdout.String(), "false:7\n"; got != want {
