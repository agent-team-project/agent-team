...
func TestQueueDoctorFormatValidation(t *testing.T) {
	cases := []struct {
		...
		{[]string{"queue", "doctor", "--commands", "--json"}, wantCommandsModeConflict("--json")},
		{[]string{"queue", "doctor", "--commands", "--format", "{{.OK}}"}, wantCommandsModeConflict("--format")},
		...
		{[]string{"queue", "show", "q-local", "--commands", "--json"}, wantCommandsModeConflict("--json")},
		{[]string{"queue", "show", "q-local", "--commands", "--format", "{{.ID}}"}, wantCommandsModeConflict("--format")},
		{[]string{"queue", "quarantine", "show", "quarantine/pending/q.json", "--commands", "--json"}, wantCommandsModeConflict("--json")},
		{[]string{"queue", "quarantine", "show", "quarantine/pending/q.json", "--commands", "--format", "{{.ID}}"}, wantCommandsModeConflict("--format")},
		{[]string{"queue", "quarantine", "restore", "quarantine/20260619T000000.000000000Z/pending/q.json", "--commands"}, wantCommandsModeRequiresDryRun()},
		{[]string{"queue", "quarantine", "restore", "quarantine/20260619T000000.000000000Z/pending/q.json", "--dry-run", "--commands", "--json"}, wantCommandsModeConflict("--json")},
		{[]string{"queue", "quarantine", "restore", "quarantine/20260619T000000.000000000Z/pending/q.json", "--dry-run", "--commands", "--format", "{{.ID}}"}, wantCommandsModeConflict("--format")},
		{[]string{"queue", "quarantine", "drop", "quarantine/20260619T000000.000000000Z/pending/q.json", "--commands"}, wantCommandsModeRequiresDryRun()},
		{[]string{"queue", "quarantine", "drop", "quarantine/20260619T000000.000000000Z/pending/q.json", "--dry-run", "--commands", "--json"}, wantCommandsModeConflict("--json")},
		{[]string{"queue", "quarantine", "drop", "quarantine/20260619T000000.000000000Z/pending/q.json", "--dry-run", "--commands", "--format", "{{.ID}}"}, wantCommandsModeConflict("--format")},
		{[]string{"queue", "drop", "q-local", "--commands"}, wantCommandsModeRequiresDryRun()},
		{[]string{"queue", "drop", "q-local", "--dry-run", "--commands", "--json"}, wantCommandsModeConflict("--json")},
		{[]string{"queue", "drop", "q-local", "--dry-run", "--commands", "--format", "{{.ID}}"}, wantCommandsModeConflict("--format")},
		{[]string{"queue", "drop", "--format", "{{.ID}}", "--json"}, "--format cannot be combined"},
		{[]string{"queue", "drop", "--format", "{{"}, "invalid --format template"},
		{[]string{"queue", "retry", "q-local", "--commands"}, wantCommandsModeRequiresDryRun()},
		{[]string{"queue", "retry", "q-local", "--dry-run", "--commands", "--json"}, wantCommandsModeConflict("--json")},
		{[]string{"queue", "retry", "q-local", "--dry-run", "--commands", "--format", "{{.ID}}"}, wantCommandsModeConflict("--format")},
		{[]string{"queue", "retry", "--format", "{{.ID}}", "--json"}, "--format cannot be combined"},
		{[]string{"queue", "retry", "--format", "{{"}, "invalid --format template"},
		{[]string{"queue", "prune", "--commands"}, wantCommandsModeRequiresDryRun()},
		{[]string{"queue", "prune", "--dry-run", "--commands", "--json"}, wantCommandsModeConflict("--json")},
		{[]string{"queue", "prune", "--dry-run", "--commands", "--format", "{{.ID}}"}, wantCommandsModeConflict("--format")},
		{[]string{"queue", "drain", "--commands"}, wantCommandsModeRequiresDryRun()},
		{[]string{"queue", "drain", "--dry-run", "--commands", "--json"}, wantCommandsModeConflict("--json")},
		{[]string{"queue", "drain", "--dry-run", "--commands", "--format", "{{.Pending}}"}, wantCommandsModeConflict("--format")},
		{[]string{"job", "queue", "quarantine", "squ-1", "--commands", "--json"}, wantCommandsModeConflict("--json")},
		{[]string{"job", "queue", "quarantine", "squ-1", "--commands", "--format", "{{.ID}}"}, wantCommandsModeConflict("--format")},
		{[]string{"job", "queue", "quarantine", "squ-1", "--commands", "--summary"}, wantCommandsModeConflict("--summary")},
		{[]string{"pipeline", "queue", "quarantine", "ticket_to_pr", "--commands", "--json"}, wantCommandsModeConflict("--json")},
		{[]string{"pipeline", "queue", "quarantine", "ticket_to_pr", "--commands", "--format", "{{.ID}}"}, wantCommandsModeConflict("--format")},
		{[]string{"pipeline", "queue", "quarantine", "ticket_to_pr", "--commands", "--summary"}, wantCommandsModeConflict("--summary")},
		{[]string{"team", "queue", "quarantine", "delivery", "--commands", "--json"}, wantCommandsModeConflict("--json")},
		{[]string{"team", "queue", "quarantine", "delivery", "--commands", "--format", "{{.ID}}"}, wantCommandsModeConflict("--format")},
		{[]string{"team", "queue", "quarantine", "delivery", "--commands", "--summary"}, wantCommandsModeConflict("--summary")},
	}
