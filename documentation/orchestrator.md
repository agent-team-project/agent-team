...
agent-team monitor [-w] [--no-clear] [-a] [--summary [--resources]] [--plan [--stop-extras] [--action start]] [--latest | --last N] [--events N [--event-action stop] [--since 10m]] [--sort status|agent|phase|stale|runtime-stale|unhealthy|started|stopped|exited|name] [--stats-sort cpu|mem|rss|status|agent|phase|stale|runtime-stale|unhealthy|name] [--format '{{.Health.Healthy}} {{len .Instances}}'] [--json] [--interval 2s] [--strict-topology] [--agent manager] [--instance manager] [--status running] [--phase idle] [--stale] [--runtime-stale] [--unhealthy]
                                  # combined health, inbox, instance, resource, and event-history snapshot; uses local metadata if the daemon is down
agent-team watch [--no-clear] [-a] [--summary [--resources]] [--plan [--stop-extras] [--action start]] [--latest | --last N] [--events N [--event-action stop] [--since 10m]] [--sort status|agent|phase|stale|runtime-stale|unhealthy|started|stopped|exited|name] [--stats-sort cpu|mem|rss|status|agent|phase|stale|runtime-stale|unhealthy|name] [--format '{{.Health.Healthy}} {{len .Instances}}'] [--json] [--interval 2s] [--strict-topology] [--agent manager] [--instance manager] [--status running] [--phase idle] [--stale] [--runtime-stale] [--unhealthy]
                                  # continuously redraw the combined operator monitor with inbox state
agent-team ps [-a] [-w] [--no-clear] [-q] [--summary] [--latest | --last N] [--sort status|agent|phase|stale|runtime-stale|unhealthy|started|stopped|exited|name] [--json] [--format '{{.Instance}} {{.Status}}'] [--status running] [--phase blocked] [--stale] [--runtime-stale] [--unhealthy] [--agent worker] [--instance worker-1]
...
agent-team stop [<instance>...] [-q] [--all] [--latest | --last N] [--agent manager] [--status running] [--phase idle] [--stale] [--runtime-stale] [--unhealthy] [-f] [--rm] [--dry-run] [--summary] [--format '{{.Instance}} {{.Action}}'] [--wait --wait-timeout 30s] [--timeout 10s] [--json]
                                  # graceful stop, keep state; --all includes ad-hoc/ephemeral instances
agent-team kill [<instance>...] [-q] [--all] [--latest | --last N] [--agent manager] [--status running] [--phase idle] [--stale] [--runtime-stale] [--unhealthy] [--rm] [--dry-run] [--summary] [--format '{{.Instance}} {{.Action}}'] [--timeout 2s] [--wait --wait-timeout 30s] [--json]
                                  # force-stop with SIGKILL escalation after the grace period
agent-team restart [<instance>...] [-q] [--all] [--latest | --last N] [--agent manager] [--status running] [--phase idle] [--stale] [--runtime-stale] [--unhealthy] [-f] [--dry-run] [--summary] [--format '{{.Instance}} {{.Action}}'] [--ready-timeout 3s] [--timeout 30s] [--wait --wait-timeout 30s] [--attach --tail N|all] [--json]
...
agent-team tick [-w | --until-idle] [--interval 2s] [--max-cycles N] [--dry-run] [--preview-routes] [--skip-reconcile] [--skip-schedules] [--skip-drain] [--skip-advance] [--limit N] [--workspace auto|worktree|repo] [--format '{{.Queue.Dispatched}} {{len .Advance}}'] [--json]
                                  # operator maintenance cycle, watch loop, or finite drain until no immediate schedule/queue/pipeline work remains
agent-team team tick <team> [-w | --until-idle] [--interval 2s] [--max-cycles N] [--dry-run] [--preview-routes] [--skip-schedules] [--skip-drain] [--skip-advance] [--limit N] [--workspace auto|worktree|repo] [--json]
                                  # scoped run, watch loop, finite drain, or preview for one team's due schedules, queue, and pipeline steps
agent-team team doctor <team>|--all [--commands] [--json]
...
agent-team team repair <team> [--dry-run] [--commands] [--jobs] [--skip-daemon] [--skip-queue] [--skip-tick] [--until-idle] [--limit N] [--workspace auto|worktree|repo] [--json]
...
agent-team team advance <team> [--limit N] [--workspace auto|worktree|repo] [--dry-run] [--preview-routes] [--format '{{.JobID}} {{.Action}} {{.StepID}}'] [--json]
                                  # dispatch or preview ready pipeline steps owned by one team
agent-team team prune <team> [-q] [--dry-run] [--older-than 24h] [--status exited|crashed] [--phase done] [--stale] [--runtime-stale] [--unhealthy] [--summary] [--format '{{.Instance}} {{.Path}}'] [--json]
...
agent-team runtime metadata ls [<instance>...] [--summary] [--latest | --last N] [--status running] [--runtime codex] [--agent worker] [--instance worker-squ-42] [--runtime-stale] [--unhealthy] [--sort instance|status|runtime|agent|stale|unhealthy|job|started|stopped|exited] [--commands] [--format '{{.Instance}} {{.Runtime}} {{.Status}}'] [--json]
                                  # repo-wide raw persisted daemon runtime metadata rows or summary without declared placeholders
agent-team runtime metadata show <instance> [--commands] [--format '{{.Instance}} {{.Runtime}} {{.Status}}'] [--json]
                                  # one raw persisted daemon runtime metadata record with durable job ownership enrichment
...
agent-team team runtime ls <team> [--summary] [--latest | --last N] [--status running] [--runtime codex] [--agent worker] [--instance worker-squ-42] [--runtime-stale] [--unhealthy] [--sort instance|status|runtime|agent|stale|unhealthy|job|started|stopped|exited] [--format '{{.Instance}} {{.Runtime}} {{.Status}}'] [--json]
                                  # scoped daemon runtime metadata rows or summary for one team's persistent members and live ephemeral children
agent-team team stats <team> [<instance>...] [-w] [--no-clear] [-a] [--latest | --last N] [--status running] [--runtime codex] [--phase idle] [--stale] [--runtime-stale] [--unhealthy] [--summary] [--sort cpu|mem|rss|status|agent|phase|stale|runtime-stale|unhealthy|name] [--format '{{.Instance}} {{.CPUPercent}} {{.RSS}}'] [--json] [--interval 2s]
                                  # scoped CPU, memory, RSS, lifecycle, and phase snapshot for one team
agent-team team monitor <team> [-w] [--no-clear] [-a] [--summary [--resources]] [--plan [--stop-extras] [--action start]] [--jobs] [--schedules] [--events N [--event-action dispatch] [--since 10m]] [--latest | --last N] [--status running] [--runtime codex] [--phase idle] [--stale] [--runtime-stale] [--unhealthy] [--sort status|agent|phase|stale|runtime-stale|unhealthy|started|stopped|exited|name] [--stats-sort cpu|mem|rss|status|agent|phase|stale|runtime-stale|unhealthy|name] [--format '{{.Team.Name}} {{len .Instances}}'] [--json] [--interval 2s]
                                  # scoped operator dashboard for one team's health, inbox, instances, resources, optional jobs, schedules, plan, and events
...
agent-team rm [<instance>...] [-q] [--all] [--finished] [--latest | --last N] [--status stopped] [--phase done] [--stale] [--runtime-stale] [--unhealthy] [--agent manager] [--dry-run] [--summary] [-f] [--format '{{.Instance}} {{.Path}}'] [--json]
                                  # remove state + daemon metadata; uses persisted metadata if the daemon is down
agent-team prune [-q] [--dry-run] [--older-than 24h] [--agent manager] [--status exited] [--phase done] [--stale] [--runtime-stale] [--unhealthy] [--summary] [--format '{{.Instance}} {{.Path}}'] [--json]
                                  # non-interactively remove finished or runtime-stale persisted daemon metadata and state
...
`agent-team runtime metadata ls` shows repo-wide persisted daemon metadata without declared-but-not-started placeholders. It is the broad raw runtime view before narrowing by job, pipeline, or team ownership. `agent-team runtime metadata show <instance>` renders one raw record with the same normalized/enriched fields used by the list command. Their `--commands` modes print repo-scoped drill-down and recovery follow-ups for scripts.
...
5. **Worktree lifecycle policy** — daemon event dispatch can create a worktree when the payload asks for `workspace = "worktree"`, but it intentionally does not remove successful workers' worktrees on process exit. The worker may have unpushed or reviewable changes. Cleanup remains explicit until the PR/branch lifecycle is better integrated.
