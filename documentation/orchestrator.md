...
agent-team team stats <team> [<instance>...] [-w] [--no-clear] [-a] [--latest | --last N] [--status running] [--runtime codex] [--phase idle] [--stale] [--unhealthy] [--summary] [--sort cpu|mem|rss|status|agent|phase|stale|unhealthy|name] [--format '{{.Instance}} {{.CPUPercent}} {{.RSS}}'] [--json] [--interval 2s]
