...
DEFAULT_CONFIG = REPO_ROOT / "template" / "gates.toml"
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--config", type=Path, default=DEFAULT_CONFIG, help="Gate-tier TOML config.")
