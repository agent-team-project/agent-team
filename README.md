...
agent-team drain [--interval 2s] [--max-cycles N] [--skip-reconcile] [--skip-schedules] [--skip-drain] [--skip-advance] [--all-ready-steps] [--limit N] [--workspace auto|worktree|repo] [--runtime claude|codex] [--runtime-bin <path>] [--format '{{.CyclesRun}} {{.Idle}}'] [--json]
