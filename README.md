...
agent-team pipeline resume-plan <pipeline> [--status crashed] [--runtime codex] [--action start|attach|resume|logs] [--summary] [--format '{{.Instance}} {{.RecommendedAction}}'] [--json]
