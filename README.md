...
agent-team team queue prune <team> [--state dead|pending|all] [--runtime codex] [--older-than 24h] [--dry-run] [--format '{{.ID}} {{.Dropped}}'] [--json]
