...
agent-team pipeline repair <pipeline> [--dry-run] [--preview-routes] [--timeout-jobs|--timeout-pipelines] [--timeout-step <id>] [--timeout-target-agent worker] [--timeout-message "..."] [--retry-pipelines] [--retry-step <id>] [--retry-message "..."] [--retry-force] [--skip-daemon] [--skip-queue] [--skip-advance] [--all-ready-steps] [--limit N] [--workspace auto|worktree|repo] [--format '{{.Pipeline}} {{.Queue.Action}}'] [--json]
