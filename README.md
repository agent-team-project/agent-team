...
agent-team repair [--dry-run] [--preview-routes] [--jobs] [--timeout-jobs|--timeout-pipelines] [--timeout-step <id>] [--timeout-message "..."] [--retry-pipelines] [--retry-step <id>] [--retry-message "..."] [--skip-daemon] [--skip-queue] [--skip-tick] [--until-idle] [--all-ready-steps] [--limit N] [--workspace auto|worktree|repo] [--format '{{.Queue.Action}}'] [--json]
...
agent-team runtime [--runtime claude|codex] [--runtime-bin <path>] [--format '{{.Runtime}} {{.Available}}'] [--json] | ls [--format '{{.Runtime}} {{.Selected}} {{.Available}}'] [--json] | probe [--runtime claude|codex] [--runtime-bin <path>] [--skip-doctor] [--exec] [--exec-prompt "..."] [--format '{{.OK}} {{len .Issues}}'] [--json]
                                                # inspect, list, or probe selected LLM runtime profile, daemon readiness, Codex doctor health, and optional Codex exec readiness
