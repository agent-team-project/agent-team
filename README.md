...
agent-team repair [--dry-run] [--preview-routes] [--jobs] [--retry-pipelines] [--retry-step <id>] [--retry-message "..."] [--skip-daemon] [--skip-queue] [--skip-tick] [--until-idle] [--all-ready-steps] [--limit N] [--workspace auto|worktree|repo] [--format '{{.Queue.Action}}'] [--json]
...
agent-team runtime [--runtime claude|codex] [--runtime-bin <path>] [--format '{{.Runtime}} {{.Available}}'] [--json] | ls [--format '{{.Runtime}} {{.Selected}} {{.Available}}'] [--json] | probe [--runtime claude|codex] [--runtime-bin <path>] [--skip-doctor] [--exec] [--exec-prompt "..."] [--json]
...
agent-team job start|stop|kill|wait|logs [--last-message|--clean]|attach|send|unblock|update|hold|release|close [--message "..."]|cancel|adopt|reopen|rm|prune|reconcile ...
