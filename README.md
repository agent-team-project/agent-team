...
agent-team queue ls [-w] [--summary] [--state pending|dead] [--instance worker] [--event-type agent.dispatch] [--ready] [--json] | show|retry|drop <id> | prune [--state dead|pending|all] [--older-than 24h] [--dry-run]
