...
agent-team queue ls [-w] [--summary] [--state pending|dead] [--instance worker] [--event-type agent.dispatch] [--job SQU-42] [--ready] [--json] | show <id> | doctor [--quarantine [--dry-run]] [--json] | quarantine ls [--state pending|dead] [--instance worker] [--event-type agent.dispatch] [--job SQU-42] [--restorable|--unrestorable] [--json] | quarantine show <path> [--json] | quarantine restore <path> [--dry-run] [--force] [--json] | quarantine drop <path>|--all [--state pending|dead] [--instance worker] [--event-type agent.dispatch] [--job SQU-42] [--restorable|--unrestorable] [--dry-run] [--older-than 24h] [--json] | drain [--dry-run] [--json] | drop <id>|--all [--dry-run] | retry <id>|--all [--dry-run] | prune [--state dead|pending|all] [--older-than 24h] [--dry-run]
