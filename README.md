...
agent-team tick [-w | --until-idle] [--interval 2s] [--max-cycles N] [--dry-run] [--preview-routes] [--skip-reconcile] [--skip-schedules] [--skip-drain] [--skip-advance] [--all-ready-steps] [--limit N] [--workspace auto|worktree|repo] [--runtime claude|codex] [--runtime-bin <path>] [--format '{{.Queue.Dispatched}} {{len .Advance}}'] [--json]
...
agent-team job create <ticket> [kickoff...] [--target worker] [--ticket-url <url>] [--kickoff "..."] [--kickoff-file <path|->] [--pipeline ticket_to_pr] [--dispatch] [--workspace auto|worktree|repo] [--runtime claude|codex] [--runtime-bin <path>] [--instance <name>] [--dry-run] [--json]
...
agent-team pipeline ls [--format '{{.Name}}'] [--json] | show <pipeline> [--format '{{.Name}}'] [--json] | graph <pipeline> [--format text|mermaid|dot] [--routes] [--json] | doctor [<pipeline>|--all] [--strict-runtime] [--format '{{.OK}}'] [--json] | status [<pipeline>|--all] [-w] [--no-clear] [--interval 2s] [--format '{{.Pipeline}}'] [--json] | triage <pipeline> [-w] [--min-severity warning] [--reason queue_dead] [--format '{{.Summary.Total}} {{len .Attention}}'] [--json] | explain [<pipeline>|--all] [-w] [--no-clear] [--interval 2s] [--state ready|failed|held|all] [--step <id>] [--limit N] [--format '{{.Pipeline}} {{len .Jobs}}'] [--json] | snapshot <pipeline> [--json|--output <file>] [--no-redact] | next [<pipeline>|--all] [-w] [--no-clear] [--interval 2s] [--team delivery] [--limit N] [--format '{{.Pipeline}} {{.Action}}'] [--json] | wait <pipeline> [--job SQU-42] [--status terminal|done|failed] [--event pipeline_done] [--timeout 5m] [--interval 500ms] [--fail-on-failed] [--format '{{.ID}} {{.Status}}'] [--json] | jobs <pipeline> [--summary] [--status running] [--held|--unheld] [--runtime codex] [--sort updated] [--format '{{.ID}}'] [--json] | ready <pipeline>|--all [-w] [--no-clear] [--interval 2s] [--state ready|held|all] [--step <id>] [--sort updated] [--limit N] [--format '{{.JobID}}'] [--json] | hold <pipeline>|--all [--state ready|failed|all] [--limit N] [--dry-run] [--format '{{.JobID}} {{.Action}}'] [--json] | release <pipeline>|--all [--limit N] [--dry-run] [--format '{{.JobID}} {{.Action}}'] [--json] | advance <pipeline>|--all [--all-ready-steps] [--limit N] [--workspace auto|worktree|repo] [--runtime claude|codex] [--runtime-bin <path>] [--dry-run] [--preview-routes] [--format '{{.JobID}}'] [--json] | approve <pipeline>|--all [--step <id>] [--dispatch] [--workspace auto|worktree|repo] [--runtime claude|codex] [--runtime-bin <path>] [--message "..."] [--message-file <path|->] [--dry-run] [--preview-routes] [--format '{{.JobID}} {{.Action}}'] [--json] | reject <pipeline>|--all [--step <id>] [--message "..."] [--message-file <path|->] [--limit N] [--dry-run] [--format '{{.JobID}} {{.Action}}'] [--json] | unblock <pipeline>|--all [message...] [--step <id>] [--status running|queued] [--limit N] [--allow-missing] [--dry-run] [--format '{{.JobID}} {{.Action}}'] [--json] | retry <pipeline>|--all [--step <id>] [--dispatch] [--workspace auto|worktree|repo] [--runtime claude|codex] [--runtime-bin <path>] [--message "..."] [--message-file <path|->] [--force] [--dry-run] [--preview-routes] [--format '{{.JobID}} {{.Action}}'] [--json] | run <pipeline> <ticket> [kickoff...] [--ticket-url <url>] [--kickoff "..."] [--kickoff-file <path|->] [--dispatch] [--workspace auto|worktree|repo] [--runtime claude|codex] [--runtime-bin <path>] [--dry-run] [--format '{{.ID}}'] [--json]
...
agent-team pipeline events <pipeline> [-f] [--runtime codex] [--tail N] [--summary] [--action stop] [--format '{{.Action}} {{.Instance}}'] [--json]
                                                # read lifecycle events for pipeline-owned instances
...
Pipeline and team job tables support live refresh with `pipeline jobs <pipeline> --watch` and `team jobs <team> --watch`; add `--summary`, `--limit 20`, `--no-clear`, or `--interval 5s` for aggregate or bounded operator dashboards.
...
Use `pipeline repair <pipeline> --dry-run --preview-routes` when the entire recovery loop should stay inside one workflow; it scopes dead-letter queue retry, optional stale-work timeout, optional failed-step retry, and the final ready-step advance to that pipeline.
