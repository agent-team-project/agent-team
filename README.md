...
agent-team intake service systemd|launchd [--bin /usr/local/bin/agent-team] [--addr 127.0.0.1:8787] [--github-reconcile-job [--github-cleanup-merged [--github-verify-pr]]]
                                                # print a systemd unit or launchd plist for running intake serve against the current repo
