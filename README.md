...
agent-team team ls [--json] | show <team> [--json] | up|down|restart <team> [--dry-run] [--json] | ps <team> [-w] [--no-clear] [--interval 2s] [--json] | jobs <team> [--status running] [--sort updated] [--format '{{.ID}}'] [--json] | pipelines <team> [--format '{{.Pipeline}}'] [--json] | schedules <team> [--format '{{.Name}}'] [--json] | health <team> [--jobs] [-q] [--json] | status <team> [-w] [--no-clear] [--interval 2s] [--json]
