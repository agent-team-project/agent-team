...
agent-team job resume-plan <job-id> [--status crashed] [--runtime codex] [--action resume|logs] [--stale] [--summary] [--format '{{.RecommendedCommand}}'] [--json]
...
agent-team pipeline resume-plan <pipeline> [--status crashed] [--runtime codex] [--action start|attach|resume|logs] [--stale] [--summary] [--format '{{.Instance}} {{.RecommendedAction}}'] [--json]
