...
agent-team repair [--dry-run] [--preview-routes] [--jobs] [--timeout-jobs|--timeout-pipelines] [--timeout-step <id>] [--timeout-pipeline name] [--timeout-target-agent worker] [--timeout-message "..."] [--retry-pipelines] [--retry-pipeline name] [--retry-step <id>] [--retry-message "..."] [--retry-force] [--skip-daemon] [--skip-queue] [--skip-tick] [--until-idle] [--all-ready-steps] [--limit N] [--workspace auto|worktree|repo] [--runtime claude|codex] [--runtime-bin <path>] [--format '{{.Queue.Action}}'] [--json]
...
agent-team pipeline repair <pipeline> [--dry-run] [--preview-routes] [--timeout-jobs|--timeout-pipelines] [--timeout-step <id>] [--timeout-target-agent worker] [--timeout-message "..."] [--retry-pipelines] [--retry-step <id>] [--retry-message "..."] [--retry-force] [--runtime claude|codex] [--runtime-bin <path>] [--skip-daemon] [--skip-queue] [--skip-advance] [--all-ready-steps] [--limit N] [--workspace auto|worktree|repo] [--format '{{.Pipeline}} {{.Queue.Action}}'] [--json]
