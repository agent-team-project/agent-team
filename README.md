...
agent-team repair [--dry-run] [--preview-routes] [--jobs] [--timeout-jobs|--timeout-pipelines] [--timeout-step <id>] [--timeout-pipeline name] [--timeout-target-agent worker] [--timeout-message "..."] [--retry-pipelines] [--retry-step <id>] [--retry-message "..."] [--skip-daemon] [--skip-queue] [--skip-tick] [--until-idle] [--all-ready-steps] [--limit N] [--workspace auto|worktree|repo] [--format '{{.Queue.Action}}'] [--json]
