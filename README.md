...
agent-team repair [--dry-run] [--preview-routes] [--jobs] [--retry-pipelines] [--retry-message "..."] [--skip-daemon] [--skip-queue] [--skip-tick] [--until-idle] [--limit N] [--workspace auto|worktree|repo] [--format '{{.Queue.Action}}'] [--json]
