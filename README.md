...
agent-team team queue prune <team> [--state dead|pending|all] [--runtime codex] [--older-than 24h] [--limit N] [--dry-run] [--format '{{.ID}} {{.Dropped}}'] [--json]
