...
| `agent-team inbox` | Inspect mailbox summaries, show messages, and acknowledge inbox cursors; `inbox ack --dry-run --commands` prints the matching apply command when the cursor would advance |
