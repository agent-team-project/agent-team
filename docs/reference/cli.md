...
| `agent-team queue doctor` | Validate queue files; add `--commands` to print recovery commands, or `--quarantine --dry-run --commands` to print the scoped quarantine apply command |
