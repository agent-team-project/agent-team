...
| `agent-team snapshot diff <before.json> <after.json>` | Compare saved diagnostic artifacts, including provenance, git context, runtime profile, instances, jobs, inboxes, queue, schedules, intake, events, and pipeline state |
