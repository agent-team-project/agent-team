...
Use `pipeline advance <pipeline> --wait` or `team advance <team> --wait` when already-created ready work should dispatch and block until the advanced step starts or reaches another requested status/event.
